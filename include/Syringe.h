/*
    ...
    Ported into SyringeIH from SyringeEx (Phobos-developers/SyringeEx, LGPLv3 API header).
    The hook ABI (REGISTERS layout), handshake struct and feature flags match SyringeIH.
*/
